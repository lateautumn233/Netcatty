...
const en: Messages = {
  ...
  'vault.groups.details.et': 'EternalTerminal',
  ...
  'hostDetails.et.serverPort': 'ET server port',
  'hostDetails.et.serverPort.desc': 'The port etserver listens on (default 2022).',
  'hostDetails.et.terminalPath': 'etterminal path',
  'hostDetails.et.terminalPath.placeholder': '/usr/local/bin/etterminal',
  'protocolSelect.etPort': 'ET port:',
  'protocolSelect.sshPort': 'SSH port:',
