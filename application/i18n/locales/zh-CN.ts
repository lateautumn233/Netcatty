...
const zhCN: Messages = {
  ...
  'hostDetails.et.serverPort': 'ET 服务端口',
  'hostDetails.et.serverPort.desc': 'etserver 监听端口（默认 2022）。',
  'hostDetails.et.terminalPath': 'etterminal 路径',
  'hostDetails.et.terminalPath.placeholder': '/usr/local/bin/etterminal',
  'protocolSelect.etPort': 'ET 端口:',
  'protocolSelect.sshPort': 'SSH 端口:',
